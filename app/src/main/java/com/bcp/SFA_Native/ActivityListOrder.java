...
public class ActivityListOrder extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(dbFile.exists()){
            try {
                if (Order.equals("1")){
                    PelangganJSON = dborder.getAllOrderBeforeSync(DB_PATH,DB_MASTER);
                }else{
                    PelangganJSON = dborder.getAllOrderAfterSync(DB_PATH,DB_MASTER,dborder.getDateTime("yyyy-MM-dd"));
                }
        ...
        final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear,
                ...
                PelangganList.clear();
                try {
                    PelangganJSON = dborder.getAllOrderAfterSync(DB_PATH,DB_MASTER,harini);
                    // Getting Array of Pelanggan
                    PelangganArray = PelangganJSON.getJSONArray(TAG_PELANGGANDATA);
        ...
        ImgFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(ActivityListOrder.this, date, myCalendar
    ...
    public void ShowKonfirmasiProsesReUpload(final int Pos){
        ...
        builder.setNegativeButton("Buka Flag", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                dborder.updateOpenFlagOrder(adapter.getItem(Pos).getAlamat());
                Toast.makeText(getApplicationContext(),"Buka Flag Berhasil, Orderan ini bisa di upload lagi via Menu Sync",Toast.LENGTH_SHORT).show();
