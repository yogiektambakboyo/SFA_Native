...
public class ActivityPelangganInv extends Activity {
    //DB Handler
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int d = dborder.getCekExistInventoryPelanggan(adapter.getItem(position).getShipTo(), getToday());
                if (d>0){
                    String kodenota = dborder.getKodenotaInventoryPelanggan(adapter.getItem(position).getShipTo(),getToday());
                    CekExistInventory(position, adapter.getItem(position).getPerusahaan(),kodenota);
                }else{
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                int d = dborder.getCekExistInventoryPelanggan(adapter.getItem(i).getShipTo(), getToday());
                if (d>0){
                    String kodenota = dborder.getKodenotaInventoryPelanggan(adapter.getItem(i).getShipTo(),getToday());
                    KonfirmasiDeleteInventory(adapter.getItem(i).getPerusahaan(), kodenota);
                }
                return false;
            }
        });
    ...
    public void CekExistInventory(final int Pos,final String Perusahaan,final String Kodenota){
    ...
    public void KonfirmasiDeleteInventory(final String Perusahaan,final String Kodenota){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Info");
        builder.setIcon(R.drawable.dfa_info_ups);
        ...
        final TextView Msg = new TextView(this);
        Msg.setText("Apakah anda yakin akan menghapus data inventory untuk pelanggan :  "+Perusahaan+"?");
        Msg.setTextSize(TypedValue.COMPLEX_UNIT_SP,16);
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dborder.deleteInventory(Kodenota);
                Toast.makeText(getApplicationContext(),"Data inventory untuk pelanggan : "+Perusahaan+" Berhasil dihapus",Toast.LENGTH_SHORT).show();
            }
        });
