...
public class ActivityListRetur extends Activity {
    //DB Handler
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(dbFile.exists()){
            try {
                if (Order.equals("1")){
                    PelangganJSON = dborder.getAllReturBeforeSync(DB_PATH, DB_MASTER);
                }else{
                    PelangganJSON = dborder.getAllReturAfterSync(DB_PATH, DB_MASTER, dborder.getDateTime("yyyy-MM-dd"));
                }
        ...
        final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear,
                ...
                PelangganList.clear();
                try {
                    PelangganJSON = dborder.getAllReturAfterSync(DB_PATH, DB_MASTER, harini);
                    // Getting Array of Pelanggan
                    PelangganArray = PelangganJSON.getJSONArray(TAG_PELANGGANDATA);
        ...
        ImgFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(ActivityListRetur.this, date, myCalendar
    ...
    public void ShowKonfirmasiDelete(final int Pos){
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                dborder.deleteRetur(adapter.getItem(Pos).getAlamat());
    ...
    public void ShowKonfirmasiProsesReUpload(final int Pos){
        ...
        builder.setNegativeButton("Buka Flag", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                dborder.updateOpenFlagRetur(adapter.getItem(Pos).getAlamat());
                Toast.makeText(getApplicationContext(),"Buka Flag Berhasil, Returan ini bisa di upload lagi via Menu Sync",Toast.LENGTH_SHORT).show();
